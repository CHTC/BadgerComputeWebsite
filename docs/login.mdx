...
- You have completed the required [BadgerCompute Certification Course](/docs/hello-jupyter/#canvas-course)
...
1. **Open the BadgerCompute Launch URL**
    ...
    Visit the BadgerCompute launch page:
		...
		<Link href={NOTEBOOK_URL}><Button variant={'outlined'} size="small" endIcon={<RocketLaunchIcon />}>Launch Notebook</Button></Link>
